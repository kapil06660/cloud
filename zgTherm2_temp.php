...
//			file_put_contents($my_log,$logdata,FILE_APPEND);
	...
	//Update schedule from Therm_Schedule table

       $sql = "SELECT Schedule FROM Therm_Schedule "
               ."WHERE (Therm_SN='$serial' and External_Update=1)";
            ...
            if ($result)
            {
              	...
              	while ($row = mysql_fetch_object($result)) 
			{
              		$outt .= "/schedule/".$row->Schedule."\r";
              	}
             
             		$sql = "UPDATE Therm_Schedule "
                        ."SET External_Update=0 "
                        ."WHERE (Therm_SN='$serial' and External_Update=1)";
                	if (mysql_query($sql,$con))
                	{
...
//$outt  .= "/schedule/add/* $rtc_time/4/19/1/65.0/1.0\r/schedule/add/* $rtc2/6/4/1/70.0/2.0\r\n";
//$outt  .= "/schedule/add/* $rtc_time/4/19/1/65.0/1.0\r/schedule/add/* $rtc2/6/4/1/70.0/2.0\r";
//$outt  .="/schedule/add/* $rtc_time/7/19/1/75.0/3.0\r/schedule/add/* $rtc2/10/4/1/72.0/4.0\r";
//$outt  .="/schedule/add/* $rtc_time/12/19/1/74.0/5.0\r/schedule/add/* $rtc2/14/4/1/76.0/6.0\r";
//$outt  .="/schedule/add/* $rtc_time/12/19/1/78.0/7.0\r/schedule/add/* $rtc2/14/4/1/66.0/8.0\r";
//$outt  .="/schedule/add/* $rtc_time/12/19/1/88.0/9.0\r/schedule/add/* $rtc2/14/4/1/96.0/10.0\r\n";
